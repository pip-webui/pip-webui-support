# Pip.WebUI Support Pages http://git.pipdevs.com/pip-webui/pip-webui-pages
...
npm install git+ssh://git@git.pipdevs.com:pip-core/pip-webui-composite.git
npm install git+ssh://git@git.pipdevs.com:pip-core/pip-webui-support.git
